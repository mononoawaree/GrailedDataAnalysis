...
def export(uri: str, out_dir: Path) -> Path:
    q = """SELECT title, department, source, category, category_path,
         ...
         seller_trusted, seller_rating_average, seller_rating_count, followers_count, heat_score,
         measurement_count, external_id, currency, local_image_path, image_download_status, original_price, scraped_at, designer_ids, designer_names, id FROM sold_listings LIMIT 10000"""
